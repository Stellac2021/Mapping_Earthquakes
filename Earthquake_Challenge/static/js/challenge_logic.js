...
// We create the third tile layer that will be teh ground or our map. 
...
// Add a layers group for all earthquakes, tectonic plates, and >4.5 earthquakes
...
let weeklyEarthquake = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";
d3.json(weeklyEarthquake).then(function(data) {
...
d3.json(largeEarthquakes).then(function(data) {
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json(tectonicData).then(function(data) {
    ...
    // Pass tectonic layer group to geoJSON() layer.
    L.geoJson(data, {
      style: {color: "gray", weight: 3},
